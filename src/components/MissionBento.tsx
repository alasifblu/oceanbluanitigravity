...
import { ShieldCheck, Cpu, Database, Zap, Layers, Sparkles } from "lucide-react";

export default function MissionBento() {
  return (
    <section className="relative py-20 md:py-28 border-b border-white/10 bg-[#05070E]">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="flex flex-col justify-between rounded-3xl border border-white/10 bg-[#0A0E1A] p-7 backdrop-blur-xl transition-all duration-300 hover:border-white/20">
            <div>
              <div className="flex flex-wrap gap-2">
                {['Air-Gapped', 'Deterministic', '200B LLM', 'Turnkey', 'Local RAG'].map((tag) => (
                  <span
                    key={tag}
                    className="rounded-full border border-white/10 bg-white/5 px-2.5 py-1 font-mono text-[0.68rem] text-[#94A3B8]"
                  >
                    {tag}
                  </span>
                ))}
          ...
          {/* Card 2: Solid Vibrant Lime Card (The Signature Pinterest High-Contrast Card) */}
          <div className="flex flex-col justify-between rounded-3xl bg-[#D4FF00] p-7 text-[#05070E] shadow-[0_0_40px_rgba(212,255,0,0.3)] transition-transform duration-300 hover:scale-[1.02]">
            <div>
              <span className="font-mono text-xs font-bold uppercase tracking-wider text-[#05070E]/70">
                Commitment to Sovereignty
              </span>
              <div className="mt-2 text-5xl font-black tracking-tight text-[#05070E]">
                100%
              </div>
            </div>
            <div className="mt-10 border-t border-[#05070E]/20 pt-5">
              <p className="text-xs font-bold leading-relaxed text-[#05070E]">
                Zero bytes egress to public clouds. Your documents, customer data, and IP remain strictly on-premise.
              </p>
            </div>
          </div>

          {/* Card 3: Deep Cobalt Elevation Card */}
          <div className="flex flex-col justify-between rounded-3xl border border-[#0066FF]/40 bg-gradient-to-b from-[#10172A] to-[#0A0E1A] p-7 backdrop-blur-xl shadow-[0_0_30px_rgba(0,102,255,0.15)] transition-all duration-300 hover:border-[#0066FF]">
            <div>
            ...
            <div className="mt-10 border-t border-white/10 pt-5">
              <p className="text-xs text-[#94A3B8] leading-relaxed">
                Autonomous cognitive labor executed without human staff triage across paperwork, CAD, and dispatch.
              </p>
            </div>
          </div>
